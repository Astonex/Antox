...
- In Android Studio, go to Help>Check For Updates. As of writing, the latest version of AS is 0.6.0
- In Android Studio again, go to Tools>Android>SDK Manager. Make sure you're using the latest SDK tools and SDK Build tools (22.6.4 and 19.1 respectively as of writing)
